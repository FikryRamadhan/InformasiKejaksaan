                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Tabel Jenis Kriminal</h4>
                            <div class="card-header-form">
                                <a href="{{ route('admin.kriminal.create') }}" class="btn btn-primary mr-2">
                                    Tambah Data
                                </a>
                            </div>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive px-4 pb-4 mt-3">
                                <table class="table table-bordered" id="datatables">
                                    ...
                                    <tbody>
                                        @if (count($kriminal) > 0)
                                            @foreach ($kriminal as $index => $data)
                                                <tr>
                                                        ...
                                                        <div class="btn-group dropright px-0 pr-2">
                                                            ...
                                                            <div class="dropdown-menu dropright">
                                                                <a class="dropdown-item has-icon"
                                                                    href="{{ route('admin.kriminal.edit', $data->id) }}">
                                                                    Edit
                                                                </a>
                                                                <form
                                                                    action="{{ route('admin.kriminal.delete', $data->id) }}"
                                                                    id="delete-form-{{ $index }}" method="post">
                                                                    @method('DELETE')
                                                                    @csrf

                                                                    <a class="dropdown-item has-icon"
                                                                        href="{{ route('admin.kriminal.delete', $data->id) }}"
                                                                        id="btn-delete-{{ $index }}">
                                                                        Hapus
                                                                    </a>
                                                                </form>
