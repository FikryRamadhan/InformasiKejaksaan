                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Tabel Bukti Pelanggar Kriminal</h4>
                            <div class="card-header-form">
                                <a href="{{ route('admin.bukti.create') }}" class="btn btn-primary mr-2">
                                    Tambah Data
                                </a>
                            </div>
                        </div>
                                                        ...
                                                        <div class="btn-group dropright px-0 pr-2">
                                                            ...
                                                            <div class="dropdown-menu dropright">
                                                                <a class="dropdown-item has-icon"
                                                                    href="{{ route('admin.bukti.edit', $data->id) }}">
                                                                    Edit
                                                                </a>
                                                                <form
                                                                    action="{{ route('admin.bukti.delete', $data->id) }}"
                                                                    id="delete-form-{{ $index }}" method="post">
                                                                    @method('DELETE')
                                                                    @csrf

                                                                    <a class="dropdown-item has-icon"
                                                                        href="{{ route('admin.bukti.delete', $data->id) }}"
                                                                        id="btn-delete-{{ $index }}">
                                                                        Hapus
                                                                    </a>
                                                                </form>
