                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Tabel Saksi Kasus Kriminal</h4>
                            <div class="card-header-form">
                                <a href="{{ route('admin.saksi.create') }}" class="btn btn-primary mr-2">
                                    Tambah Data
                                </a>
                            </div>
                        </div>
                                                        ...
                                                        <div class="btn-group dropright px-0 pr-2">
                                                            ...
                                                            <div class="dropdown-menu dropright">
                                                                <a class="dropdown-item has-icon"
                                                                    href="{{ route('admin.saksi.edit', $data->id) }}">
                                                                    Edit
                                                                </a>
                                                                <form
                                                                    action="{{ route('admin.saksi.delete', $data->id) }}"
                                                                    id="delete-form-{{ $index }}" method="post">
                                                                    @method('DELETE')
                                                                    @csrf

                                                                    <a class="dropdown-item has-icon"
                                                                        href="{{ route('admin.saksi.delete', $data->id) }}"
                                                                        id="btn-delete-{{ $index }}">
                                                                        Hapus
                                                                    </a>
                                                                </form>
